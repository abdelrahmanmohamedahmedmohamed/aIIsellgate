...
function displayComments() {
  ...
  for (var j = 0; j < comments.length; j++) {
    if (comments[j].primary == 1) {
      document.getElementsByClassName("anotherCard")[j].style.border =
        "thick solid green";
    }
  }
}
...
let postLocation = document.getElementsByClassName("btnPostLocation");
if (postLocation !== undefined) {
  postLocation[0].addEventListener("click", function () {
